...
# Update the setup_hook function to include chess commands
@bot.event
...
async def help_command(interaction: discord.Interaction):
    ...
    # Chess tournament commands
    embed.add_field(
        name="Chess Tournament Commands",
        value=(
            "`/chess create` - Create a new chess tournament\n"
            "`/chess list` - List all tournaments\n"
            ...
            "`/chess help` - Show all chess commands"
        ),
        inline=False
    )
